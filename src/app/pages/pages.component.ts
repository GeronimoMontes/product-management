...
const menuSidebar: MenuSidebar[] = [
  ...
  {icon: "fas fa-table", text: "Table Paginate", action: 'pages/products/table-paginate', childs: null},
  {icon: "fas fa-table", text: "Table Scroll", action: 'pages/products/table-scroll', childs: null},
